namespace Clix.Utilities
{
	...
	public static class ConfigurationHelper
	{
		...
		/// </returns>
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1021:AvoidOutParameters", MessageId = "2#", Justification = "Reviewed, ok here")]
		public static bool GetValue<T>(NameValueCollection appSettings, string key, out T value)
		{
			if (appSettings == null)
				throw new ArgumentNullException(nameof(appSettings), "App settings cannot be null.");
			if (string.IsNullOrWhiteSpace(key))
				throw new ArgumentException("A valid configuration key needs to be specified.", nameof(key));
